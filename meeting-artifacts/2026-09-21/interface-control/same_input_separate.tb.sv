...
module tb_same_input_separate;
  ...
  same_input_separate dut(.operand_a_i(operand_a_i), .operand_b_i(operand_b_i),
  ...
  initial begin
    ...
    $display("INTERFACE_CONTROL_TEST_PASS case=same_input_separate checks=%0d vectors=%0d", checks, checks/2); $finish;
  end
endmodule
