...
module tb_same_input_shared;
  ...
  same_input_shared dut(.operand_a_i(operand_a_i), .operand_b_i(operand_b_i),
  ...
  initial begin
    ...
    $display("INTERFACE_CONTROL_TEST_PASS case=same_input_shared checks=%0d vectors=%0d", checks, checks/2); $finish;
  end
endmodule
