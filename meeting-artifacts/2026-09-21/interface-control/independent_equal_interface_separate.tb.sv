`timescale 1ns/1ps
module tb_independent_equal_interface_separate;
  ...
  independent_equal_interface_separate dut(.operand_a_i(operand_a_i), .operand_b_i(operand_b_i),
  ...
  initial begin
    ...
    $display("INTERFACE_CONTROL_TEST_PASS case=independent_equal_interface_separate checks=%0d vectors=%0d", checks, checks/2); $finish;
  end
endmodule
