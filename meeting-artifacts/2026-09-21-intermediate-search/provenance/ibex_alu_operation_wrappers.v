...
module ibex_alu_operation_wrapper (
	...
	parameter [6:0] OP = 7'd0;
	parameter [0:0] IS_COMPARISON = 1'b0;
	input wire [31:0] operand_a_i;
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	wire [31:0] alu_result;
	wire comparison_result;
	ibex_alu #(.RV32B(32'sd0)) u_ibex_alu(
		.operator_i(OP),
	...
	assign result_o = (IS_COMPARISON ? {31'b0000000000000000000000000000000, comparison_result} : alu_result);
endmodule
module ibex_alu_add32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd0)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_sub32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd1)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_lt32 (
	operand_a_i,
	operand_b_i,
	result_o
);
...
module ibex_alu_xor32 (
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd2)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_or32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd3)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_and32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd4)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_sll32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd10)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_srl32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd9)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
endmodule
module ibex_alu_sra32 (
	operand_a_i,
	operand_b_i,
	result_o
);
	...
	input wire [31:0] operand_b_i;
	output wire [31:0] result_o;
	ibex_alu_operation_wrapper #(.OP(7'd8)) u(
		.operand_a_i(operand_a_i),
		.operand_b_i(operand_b_i),
		.result_o(result_o)
	);
